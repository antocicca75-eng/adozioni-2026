...
# =========================================================
    ...
    with st.container(border=True):
        ...
        if st.button("🔍 RICERCA"): st.session_state.r_attiva = True
...
# =========================================================  
t.markdown("<p style='text-align: center; color: gray;'>Created by Antonio Ciccarelli v13.4</p>", unsafe_allow_html=True)
